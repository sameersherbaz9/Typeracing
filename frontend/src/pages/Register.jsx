...
const Register = () => {
  const [form, setForm] = useState({ username: '', email: '', password: '', avatar: '🏎️' });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 bg-grid">
      ...
      <div className="w-full max-w-md animate-slide-up relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-dark-300 text-sm mt-3">Create your free account</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 border border-white/5">
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Avatar picker */}
            <div>
              <label className="block text-sm font-medium text-dark-100 mb-2 font-display">Choose Avatar</label>
                  ...
                  <button
                    ...
                    className={`text-2xl p-2 rounded-xl transition-all duration-200 ${
                      form.avatar === av
                        ...
                        : 'bg-dark-700 border border-transparent hover:border-white/10'
                    }`}
                  >
                    {av}
                  </button>
            ...
            <div>
              <label className="block text-sm font-medium text-dark-100 mb-2 font-display">Username</label>
              <input
                type="text"
                required
                minLength={3}
